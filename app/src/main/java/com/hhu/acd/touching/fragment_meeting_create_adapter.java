...
public class fragment_meeting_create_adapter extends RecyclerView.Adapter<fragment_meeting_create_adapter.ViewHolder> {
    private OnItemClickListener onItemClickListener;
    private ArrayList<Meetings> mData;
    private Context context;
    private Resources resources;
    public fragment_meeting_create_adapter(Context context, ArrayList<Meetings> data) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.meeting_name.setText(mData.get(position).getTname());
        holder.meeting_idnumber.setText(mData.get(position).getTid());
