...
public class fragment_meeting_join extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        view = inflater.inflate(R.layout.fragment_meeting_brief_message_join, null);
        easyRefreshLayout = view.findViewById(R.id.meeting_easylayout_join);
    ...
    private void initView() {
        mRecyclerView = view.findViewById(R.id.fragment_my_meeting_join);
        // 设置布局管理器
    ...
    private static class MyHandler extends Handler {
        ...
        //对Activity的弱引用
        private final WeakReference<fragment_meeting_join> mActivity;

        public MyHandler(fragment_meeting_join activity) {
            mActivity = new WeakReference<fragment_meeting_join>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final fragment_meeting_join activity = mActivity.get();
            if (activity == null) {
